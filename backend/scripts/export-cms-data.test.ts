  ...
  return {
    ...
    getSettings: async () => ({
      ...
      draftPayload: {
        ...
        downloadA: 'https://cdn.example/private?secret=fake-secret-url',
        downloadB: 'https://cdn.example/private?password=fake-password-url',
        downloadC: 'https://cdn.example/private?reset_token=fake-reset-token-url',
        downloadD: 'https://cdn.example/private?access_key=fake-access-key-url',
        terminologyUrl: 'https://docs.example/glossary?topic=reset_token+secret+password+access_key',
      },
